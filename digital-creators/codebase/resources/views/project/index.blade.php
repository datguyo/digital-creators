    ...
    <section class="mb-0 ml-0 mr-0 mt-0 pb-20 pl-0 pr-0 pt-20">
        <div class="max-w-[80rem] mt-0 mr-auto mb-0 ml-auto pt-0 pr-8 pb-0 pl-8 md:pr-6 md:pl-6 xl:pr-10 xl:pl-10">
            <div class="flex justify-between items-center">
                <h1 class="font-semibold m-0 font-poppins text-4xl">My projects</h1>
                ...
                @foreach($works as $work)
                    <div>
                        <div class="bg-[#f4f4f5] bg-opacity-100 h-[200px] mt-0 mr-0 mb-4 ml-0 relative overflow-hidden flex items-center justify-center">
                            <div class="absolute left-auto right-0 p-3 flex space-x-2 top-0">

                                <form method="POST" action="/project/{{$work->slug}}">
                                    @csrf
                                    @method('delete')

                                    <button type="submit" class="flex items-center justify-center bg-black text-white text-opacity-100 bg-opacity-70 p-1.5 rounded-md cursor-pointer">
                                        <i class="inline-block w-[14px] h-[14px]">
                                ...
                                <a class="justify-center bg-black text-white text-opacity-100 bg-opacity-70 p-1.5 rounded-md cursor-pointer flex items-center" href="{{ route('work.edit', ['work' => $work->slug]) }}">
                                    <i class="inline-block w-[14px] h-[14px]">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
