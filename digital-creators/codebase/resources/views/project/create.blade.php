...
@section('content')
    <section class="mb-0 ml-0 mr-0 mt-0 pb-20 pl-0 pr-0 pt-20">
        <div class="mt-0 mr-auto mb-0 ml-auto pt-0 pr-8 pb-0 pl-8 md:pr-6 md:pl-6 xl:pr-10 xl:pl-10 max-w-[60rem]">
            <h1 class="font-semibold m-0 font-poppins text-4xl">Add project</h1>
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('work.store') }}" class="mb-0 ml-0 mr-0 mt-10">
                @csrf
