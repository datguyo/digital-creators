...
@section('content')
    <section class="mb-0 ml-0 mr-0 mt-0 pb-20 pl-0 pr-0 pt-20">
        <div class="mt-0 mr-auto mb-0 ml-auto pt-0 pr-8 pb-0 pl-8 md:pr-6 md:pl-6 xl:pr-10 xl:pl-10 max-w-[60rem]">
            <h1 class="font-semibold m-0 font-poppins text-4xl">Edit project</h1>
            ...
            <form method="POST" action="{{ route('work.update', ['work' => $work->slug]) }}" class="mb-0 ml-0 mr-0 mt-10" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="mt-0 mr-0 mb-6 ml-0 grid grid-cols-3 items-center md:grid-cols-1 md:gap-2">
                    <label class="block mt-0 mr-0 ml-0 text-sm tracking-wide leading-relaxed mb-0 font-poppins font-medium">Title</label>
                    <input
                        ...
                        type="text" placeholder="Name" id="27w3y0fi7" name="name" required=""
                        value="{{ $work->name ?? null }}" autocomplete="off"
                    />
                </div>
                ...
                <div class="mt-0 mr-0 mb-6 ml-0 grid grid-cols-3 items-center md:grid-cols-1 md:gap-2">
                    <label class="block mt-0 mr-0 ml-0 text-sm tracking-wide leading-relaxed mb-0 font-poppins font-medium">Image</label>
                ...
                @error('description')
                    <div class="text-sm text-[#991b1b] pt-3 pr-5 pb-3 pl-5 rounded-md bg-opacity-100 bg-[#fca5a5] mt-0 mr-0 mb-6 ml-0 hidden"
                         style="display: block;">
                        <span>
                            <div>{{ $message }}</div>
                        </span>
                ...
                <div class="mt-0 mr-0 mb-6 ml-0 grid grid-cols-3 items-start md:grid-cols-1 md:gap-2">
                    <label class="block mr-0 ml-0 text-sm tracking-wide leading-relaxed mb-0 font-poppins font-medium mt-2">Short description</label>
                    <textarea
                        class="w-full pt-2 pr-3 pb-2 pl-3 text-sm tracking-wide leading-relaxed rounded-md border-solid border border-[#52525b] border-opacity-25 shadow-sm col-span-2"
                        id="0cojb9o69"
                        name="description"
                        rows="4"
                        required=""
                    >{{ $work->description ?? null }}</textarea>
                </div>
                <button
                    class="tracking-wide leading-relaxed pt-2 pr-5 pb-2 pl-5 rounded-md flex items-center space-x-1.5 bg-[#5eead4] bg-opacity-100 text-[#134e4a] text-opacity-100 text-base font-poppins hover:text-[#134e4a] hover:text-opacity-100 hover:bg-[#99f6e4] hover:bg-opacity-100 mb-0 ml-auto mr-0 mt-0 focus:outline-none"
                    type="submit">
                    <span>Submit</span>
                </button>
            </form>
