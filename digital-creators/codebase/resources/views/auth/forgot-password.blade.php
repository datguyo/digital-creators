...
@section('content')
    <div class="max-w-7xl mt-0 mr-auto mb-0 ml-auto min-h-full flex items-center justify-center flex-col p-12">
        <h1 class="font-semibold m-0 font-poppins text-4xl">Reset password</h1>

        <form method="POST" action="{{ route('password.email') }}" class="w-6/12 mt-12 mr-auto mb-0 ml-auto sm:w-full xs:w-full flex flex-col items-start">
            @csrf
            ...
            <div class="mt-0 mr-0 mb-6 ml-0 w-[100%]">
                <label class="block mt-0 mr-0 ml-0 text-sm tracking-wide leading-relaxed mb-0 font-poppins font-medium" for="hyyaqg664">Email</label>
                <input
